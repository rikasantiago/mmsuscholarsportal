...
.button1:hover {
  ...
  <a href="#" class="w3-bar-item w3-button" style="font-size:1.4vw;"><i class="glyphicon glyphicon-list" style="font-size:2vw; left:-0.5vw;color:black;"></i>List of Scholars</a><br><br>
  ...
  <a href="scholarshipprogramadmin" class="w3-bar-item w3-button" style="font-size:1.4vw;"><i class="glyphicon glyphicon-education" style="font-size:2vw; left:-0.5vw;color:black;"></i>Scholarship Programs</a><br><br>
  <a href="welcome" class="w3-bar-item w3-button" style="font-size:1.4vw; color:red;"><i class="glyphicon glyphicon-log-out" style="font-size:2vw; left:-0.5vw;color:black;"></i>Logout</a><br><br>
</div><br><br>


    <!-- Page Content -->
    <div style="margin-left:22%;  margin-top:-102vw;">
    </div><br>
...
<h2 style="color:#fff; font-weight:bolder;">Personal Data Sheet</h2>
    ...
    <a href="scholarshipdetailsadmin"><button type="button" class="greenbutton" style="  margin-top:-4vw; margin-right:-0vw;margin-left:5vw">SCHOLARSHIP</button></a>
