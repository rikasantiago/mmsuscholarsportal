    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-input id="course" class="block mt-1 w-full" type="text" name="course" :value="old('course')" required />
            </div>
            ...
            <div>
                ...
                <x-input id="college" class="block mt-1 w-full" type="text" name="college" :value="old('college')" required />
            </div>
