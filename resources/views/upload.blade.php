...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>MMSU Scholar's Portal | Upload Free Higher Education Form</title>
...
<div class="w3" style="margin-left:0vw;">
        ...
        <p style="float:left; font-size:2vw; font-weight:bolder; color:#000;">Upload Free Higher Education Form</p>
        </div>
